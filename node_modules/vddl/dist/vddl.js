...
var Draggable = { template: "<div class=\"vddl-draggable\"><slot></slot></div>",
  name: 'vddl-draggable',
...
var List = { template: "<div class=\"vddl-list\"><slot></slot></div>",
  name: 'vddl-list',
...
var Handle = { template: "<div class=\"vddl-handle\"><slot></slot></div>",
  name: 'vddl-handle',
  props: {
    handleLeft: Number,
    handleTop: Number,
...
var Nodrag = { template: "<div class=\"vddl-nodrag\"><slot></slot></div>",
  name: 'vddl-nodrag',
  props: {},
  data: function data() {
    return {};
