...
// import AutoForm_Editor from '../autoform_editor/index'; import
// AutoForm_Editor from '../autoform_editor/dist/lib';
...
Vue
    .$autoform
    .registerDirWithConfig(() => require.context('./components/custom'), 'c');

    Vue
    .$autoform
    .RegisterDir(() => require.context('./components/aa'), 'c');
